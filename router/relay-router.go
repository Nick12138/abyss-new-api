...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.FreeRequestGrantLimit())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.FreeRequestGrantLimit())
	...
	}
	{
		...
		httpRouter.Use(middleware.FreeRequestGrantLimit())
	...
	relaySunoRouter.Use(middleware.FreeRequestGrantLimit())
	{
	...
	relayGeminiRouter.Use(middleware.FreeRequestGrantLimit())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.FreeRequestGrantLimit())
	{
