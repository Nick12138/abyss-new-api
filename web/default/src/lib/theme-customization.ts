 ...
 *   to serif; other presets fall back to sans unless they list a different
 *   choice. Mirrors how
 ...
 * `resolveThemeFont` default of `sans`. The shipped default preset stays on
 * the humanist sans for a compact operational UI; Anthropic keeps the
